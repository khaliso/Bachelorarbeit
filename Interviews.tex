...
Bei den Interviews in dieser Arbeit wurden folgende Probleme/Information needs aufgedeckt:
...
Juristisch:
    Wie bekomme ich eine permanente Aufenthaltsgenehmigung?
...
Sprachlich:
    ...
    Bayrisch (IT1.1 min15:43, vgl sozial)
    Wie kommuniziere ich am besten mit dem Arzt, ohne dessen Sprache zu sprechen? (IT2, min28, vgl medizinisch)
    Wie lerne ich die Landessprache? (IT3, min9:33)

Sonstige:
    Wie kann ich Termine pünktlich wahrnehmen (IT2, min62f.)
...
Asylverfahren: Duldung (Seit Anfan 2018), laufendes Verfahren nach §25a). Interview beim BAMF:                        min26/27. 2x abgelehnt,
...
(Infolücke: Als Lackierer keine weißen Klamotten anziehen. Wie behomen? DIe haben's Ihm gesagt!         min15/16)
...
informationslücken
min4    wie lang muss ich auch's BAMF warten? -> ging nicht mehr zum BAMF, jetzt         §25a
